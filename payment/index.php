...
<body style="background-repeat: no-repeat; padding-top:50px">
<div class="container mt-5">
<div class="row">
<div class="col-xs-12 col-md-12 mt-5">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title text-center">Booking Page </h4>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="check_in" id="check_in" min-length="10" max-length="10" placeholder="check-in date" required="" autofocus="">
                        </div>

                        <div class="form-group">
                            <label>check-out</label>
                            <input type="date" class="form-control" name="check_out" id="check_out" min-length="10" max-length="10" placeholder="check-out date" required="" autofocus="">
                        </div>
                        
                         <div class="form-group">
                            <label>Payment Amount</label>
                            <input type="text" class="form-control" name="payAmount" id="payAmount" value="2000" placeholder="Enter Amount" required="" autofocus="">
                        </div>
...
var request_url="submitpayment.php";
    ...
    window.location.replace("http://localhost/HotelBookingWebsite/payment/payment-success.php?oid="+orderID+"&rp_payment_id="+response.razorpay_payment_id+"&rp_signature="+response.razorpay_signature);
 
    },
    "modal": {
    "ondismiss": function(){
         window.location.replace("http://localhost/HotelBookingWebsite/payment/payment-success.php?oid="+orderID);
     }
},
...
rzp1.on('payment.failed', function (response){
    ...
    window.location.replace("http://localhost/HotelBookingWebsite/payment/payment-failed.php?oid="+orderID+"&reason="+response.error.description+"&paymentid="+response.error.metadata.payment_id);
